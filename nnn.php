...
?>
    ...
    <body>
        <?php
            ...
            require_once 'model/gorgeousParlour/Appointment.php';
        ?>
                                ...
                                <div class="panel panel-widget">
                                    <div class="row">
                                        ...
                                        <table class="table table-sm">
                                            ...
                                            <tbody>
                                                <?php foreach ($service as $servv) {  ?>
                                                <tr>
                                                    <td>
                                                        <?php echo $servv['BOOK_ID']?>
                                                    </td>
                                                    <td>
                                                        <?php echo $servv['USERNAME']?>
                                                    </td>
                                                    <td>
                                                        <?php echo $servv['MOBILE_NO']?>
                                                    </td>
                                                    <td>
                                                        <?php echo $servv['ADDRESS']?>
                                                    </td>
                                                    <td>
                                                        <?php echo $servv['SERVICE_NAME']?>
                                                    </td>
                                                    <td>
                                                        <?php echo $servv['PRICE']?>
                                                    </td>
                                                    <td>
                                                        <?php echo $servv['SERVICE_AT']?>
                                                    </td>
                                                    <td>
                                                        <?php echo $servv['SERVICE_DATETIME']?>
                                                    </td>
                                                    <td>
